...
class EquipmentSurveysXlsxForDockingPlan(models.AbstractModel):
    _name = "report.docking.docking_equipment_surveys_xlsx_for_docking_plan"
    _inherit = ["report.report_xlsx.abstract"]

    def generate_xlsx_report(self, workbook, data, docking_plans):
        sheet = workbook.add_worksheet("Khảo sát thiết bị")

        surveys = docking_plans.mapped(lambda e: e.equipment_survey_data_ids)
    ...
    def create_footer(self, workbook, sheet, quote_len=0, taken_row=2):

...
class MaterialSurveysXlsxForDockingPlan(models.AbstractModel):
    _name = "report.docking.docking_material_surveys_xlsx_for_docking_plan"
    _inherit = ["report.report_xlsx.abstract"]

    def generate_xlsx_report(self, workbook, data, docking_plans):
        sheet = workbook.add_worksheet("Khảo sát vật tư")

        surveys = docking_plans.mapped(lambda e: e.material_survey_data_ids)
